...
public class UserController{
	...
	public User loginUser(@RequestBody User user) throws Exception {
		...
		String encodedPassword=generateHash(password);
		ms.encryptPassword(userId, encodedPassword);
		}
		
		AuthenticationRequest ar=new AuthenticationRequest(userId, 
				password);
		ResponseEntity<?> userA=createAuthenticationToken(ar);
		Logger.global.info("The response entity is :"+userA.toString());
		return user;
	}
